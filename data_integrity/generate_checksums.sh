...
then
    ...
    do
        ...
        then
            ...
            read -r user_edit_save_previous
        ...
        then
            ...
            read -r checksum_file_ext
        fi

        echo
        print_script_parameters
        echo -ne "\nDo you wish to continue editing? (y/n): "
        read -r user_continue_editing_consent
